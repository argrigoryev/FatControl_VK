...
const Intro = ({ id, go, route, fetchedUser, userHasSeenIntro }) => (
	<Panel id={id} centered={true}>
		<PanelHeader>Контроль веса</PanelHeader>
			...
			<Fragment>
				<Group>
					<Div className='User'>
						...
						<h3>Введите свои данные, и приложение FatControl рассчитает индекс массы тела, расскажет все о КБЖУ, покажет Ваш оптимальный вес.</h3>
					</Div>
				</Group>
